...
case "$benchmark" in
    ...
    global_norm)
        ...
        ;;
    *)
        echo "usage: bash scripts/profile.sh {rmsnorm|swiglu|matmul|rope|softmax|attention|flash_attention|transformer_block|embedding|adamw|cross_entropy|global_norm}" >&2
        exit 1
        ;;
esac
