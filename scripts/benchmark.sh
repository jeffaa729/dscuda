...
if [[ $# == 0 || "$1" == "--help" || "$1" == "-h" ]]; then
    ...
    echo "options: --reference pytorch|cublas|fastcu|deepgemm|flash_attention|flashmla|both|fla, --operation NAME"
    echo "matmul: --reference both compares cuBLAS and fast.cu Kernel 12 on SM90"
